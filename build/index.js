...
// app/css/custom.css
var custom_default = "/build/_assets/custom-CMGYMWPF.css";
...
var rgb = (c) => `rgb(${c[0]},${c[1]},${c[2]})`, isDark = (c) => 0.299 * c[0] + 0.587 * c[1] + 0.114 * c[2] < 140, SPECTRUM = [
  [0, [91, 58, 209]],
  [0.14, [53, 99, 216]],
  [0.28, [43, 155, 196]],
  [0.42, [53, 171, 124]],
...
function SkyMap({
  ...
  useEffect3(() => {
    ...
    ctx.save(), ctx.beginPath(), ctx.ellipse(cx, cy, 2 * scale, scale, 0, 0, Math.PI * 2), ctx.clip(), ctx.fillStyle = dark ? "rgba(255,255,255,0.05)" : "#f2f5fa", ctx.fillRect(0, 0, width, height);
    ...
    for (let i = 0; i < tiles.count; i += 1) {
      ...
      ctx.fillStyle = emphasized && !emphasized[i] ? dark ? "rgba(255,255,255,0.12)" : "rgba(10,16,28,0.10)" : rgb(viridis(value(i))), ctx.fillRect(px(x) - w / 2, py(y) - h / 2, w, h);
    }
      ...
      "svg",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx29("g", { children: [...shapes].sort((a, b) => Number(Boolean(a.tile.highlight)) - Number(Boolean(b.tile.highlight))).map(({ tile, points }) => {
            let active = tile.highlight !== !1, color = viridis(
      ...
      /* @__PURE__ */ jsx37("section", { className: "fullpage-section section--alt", children: /* @__PURE__ */ jsx37("div", { className: "container container--wide", children: /* @__PURE__ */ jsxs34("div", { className: "reveal", children: [
        ...
        /* @__PURE__ */ jsxs34("div", { className: "home-survey", children: [
          /* @__PURE__ */ jsx37("div", { className: "home-survey__map", children: tiles && tiles.count > 0 ? /* @__PURE__ */ jsxs34(Fragment18, { children: [
            /* @__PURE__ */ jsx37("div", { className: "home-survey__stamp", children: /* @__PURE__ */ jsx37(LiveBadge, { live: tilesLive, updated: generatedAt, onDark: !0 }) }),
            /* @__PURE__ */ jsx37(
              SkyMap,
              {
                tiles,
            ...
            /* @__PURE__ */ jsxs34("div", { className: "home-survey__meta", children: [
              ...
              /* @__PURE__ */ jsx37(
                Link21,
                {
                  ...
                  children: "Explore the coverage map"
                }
              )
            ] })
          ] }) : null }),
