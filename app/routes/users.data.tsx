...
export const meta: MetaFunction = () => [
  { title: 'How to use the data · 7DT for users' },
  {
    name: 'description',
    content:
      'Data policy, rights and acknowledgment for 7DT observations, and where to find the format and access details.',
  },
];
...
const Index = () => (
  <PageLayout menu="manuUsers">
    ...
    <Section eyebrow="Policy" title="Data rights and publication">
      <div className="split split--wide-text">
        ...
        <div className="panel">
          ...
          <p className="feature-list__body" style={{ marginBottom: 0 }}>
            ...
            funding bodies. The current wording is listed on the{' '}
    ...
    <Section eyebrow="Release" title="What is public and when" alt>
      <p className="prose">
        There is no public data release yet. A release of survey products is being prepared
        alongside the completion of the Reference Imaging Survey, whose first full cycle is
        anticipated by the end of 2027. Until then, data are available on request and are handled
    ...
    <Section eyebrow="Working with it" title="What to know before you start">
        ...
        <li>
          ...
          <div>
            ...
            <p className="feature-list__body">
              Check <code>SANITY</code> before using a frame: a false value means the pipeline
              judged the image unusable and recorded the stage at which it did so. Measured seeing,
              depth, ellipticity and astrometric precision are in the header of every product.
            </p>
          </div>
        </li>
        <li>
