...
if (!window.$RefreshReg$ || !window.$RefreshSig$ || !window.$RefreshRuntime$) {
  ...
  window.$RefreshReg$ = (type, id) => {
    window.$RefreshRuntime$.register(type, '"app/routes/data.software.tsx"' + id);
  };
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1712815622733.6472";
}
var Index = () => {
...
_c = Index;
var data_software_default = Index;
var _c;
$RefreshReg$(_c, "Index");
window.$RefreshReg$ = prevRefreshReg;
window.$RefreshSig$ = prevRefreshSig;
export {
  data_software_default as default
};
//# sourceMappingURL=/build/routes/data.software-SFH35YOO.js.map
