...
if (!window.$RefreshReg$ || !window.$RefreshSig$ || !window.$RefreshRuntime$) {
  ...
  window.$RefreshReg$ = (type, id) => {
    window.$RefreshRuntime$.register(type, '"app/routes/survey.status.tsx"' + id);
  };
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1712814436289.404";
}
var Index = () => {
...
_c = Index;
var survey_status_default = Index;
var _c;
$RefreshReg$(_c, "Index");
window.$RefreshReg$ = prevRefreshReg;
window.$RefreshSig$ = prevRefreshSig;
export {
  survey_status_default as default
};
//# sourceMappingURL=/build/routes/survey.status-25ZOGSSJ.js.map
