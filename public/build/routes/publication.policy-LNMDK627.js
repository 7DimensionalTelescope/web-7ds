...
if (!window.$RefreshReg$ || !window.$RefreshSig$ || !window.$RefreshRuntime$) {
  ...
  window.$RefreshReg$ = (type, id) => {
    window.$RefreshRuntime$.register(type, '"app/routes/publication.policy.tsx"' + id);
  };
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1712819063953.1775";
}
var Index = () => {
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { style: {
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "mx-auto w-full main-container", style: {
      ...
      maxWidth: "1200px",
      margin: "0 auto"
    }, children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("p", { className: "mt-4 text-sm leading-7 text-gray-500 font-regular", style: {
      textAlign: "center"
    }, children: "To be determined." }, void 0, false, {
      fileName: "app/routes/publication.policy.tsx",
      lineNumber: 38,
      columnNumber: 13
    }, this) }, void 0, false, {
...
_c = Index;
var publication_policy_default = Index;
var _c;
$RefreshReg$(_c, "Index");
window.$RefreshReg$ = prevRefreshReg;
window.$RefreshSig$ = prevRefreshSig;
export {
  publication_policy_default as default
};
//# sourceMappingURL=/build/routes/publication.policy-LNMDK627.js.map
