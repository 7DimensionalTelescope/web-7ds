...
function IconBase(props) {
  var elem = function(conf) {
    var attr = props.attr, size3 = props.size, title = props.title, svgProps = __rest(props, ["attr", "size", "title"]);
...
var Alert = ({ additionalContent, children, className, color = "info", icon: Icon, onDismiss, rounded = true, theme: customTheme = {}, withBorderAccent, ...props }) => {
  ...
  return (0, import_jsx_runtime.jsxs)("div", { className: twMerge(theme2.base, theme2.color[color], rounded && theme2.rounded, withBorderAccent && theme2.borderAccent, className), role: "alert", ...props, children: [(0, import_jsx_runtime.jsxs)("div", { className: theme2.wrapper, "data-testid": "flowbite-alert-wrapper", children: [Icon && (0, import_jsx_runtime.jsx)(Icon, { className: theme2.icon, "data-testid": "flowbite-alert-icon" }), (0, import_jsx_runtime.jsx)("div", { children }), typeof onDismiss === "function" && (0, import_jsx_runtime.jsx)("button", { "aria-label": "Dismiss", className: twMerge(theme2.closeButton.base, theme2.closeButton.color[color]), onClick: onDismiss, type: "button", children: (0, import_jsx_runtime.jsx)(HiX, { "aria-hidden": true, className: theme2.closeButton.icon }) })] }), additionalContent && (0, import_jsx_runtime.jsx)("div", { children: additionalContent })] });
};
...
var PaginationButton = ({ active, children, className, onClick, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime2.jsx)("button", { type: "button", className: twMerge(active && theme2.pages.selector.active, className), onClick, ...props, children });
};
PaginationButton.displayName = "Pagination.Button";
var PaginationNavigation = ({ children, className, onClick, theme: customTheme = {}, disabled = false, ...props }) => {
  const theme2 = mergeDeep(getTheme().pagination, customTheme);
  return (0, import_jsx_runtime2.jsx)("button", { type: "button", className: twMerge(disabled && theme2.pages.selector.disabled, className), disabled, onClick, ...props, children });
};
...
// node_modules/flowbite-react/lib/esm/components/Pagination/Pagination.js
var PaginationComponent = ({ className, currentPage, layout = "pagination", nextLabel = "Next", onPageChange, previousLabel = "Previous", renderPaginationButton = (props2) => (0, import_jsx_runtime3.jsx)(PaginationButton, { ...props2 }), showIcons: showIcon = false, theme: customTheme = {}, totalPages, ...props }) => {
  const theme2 = mergeDeep(getTheme().pagination, customTheme);
  ...
  return (0, import_jsx_runtime3.jsxs)("nav", { className: twMerge(theme2.base, className), ...props, children: [layout === "table" && (0, import_jsx_runtime3.jsxs)("div", { className: theme2.layout.table.base, children: ["Showing ", (0, import_jsx_runtime3.jsx)("span", { className: theme2.layout.table.span, children: firstPage }), " to\xA0", (0, import_jsx_runtime3.jsx)("span", { className: theme2.layout.table.span, children: lastPage }), " of\xA0", (0, import_jsx_runtime3.jsx)("span", { className: theme2.layout.table.span, children: totalPages }), " Entries"] }), (0, import_jsx_runtime3.jsxs)("ul", { className: theme2.pages.base, children: [(0, import_jsx_runtime3.jsx)("li", { children: (0, import_jsx_runtime3.jsxs)(PaginationNavigation, { className: twMerge(theme2.pages.previous.base, showIcon && theme2.pages.showIcon), onClick: goToPreviousPage, disabled: currentPage === 1, children: [showIcon && (0, import_jsx_runtime3.jsx)(HiChevronLeft, { "aria-hidden": true, className: theme2.pages.previous.icon }), previousLabel] }) }), layout === "pagination" && range(firstPage, lastPage).map((page) => (0, import_jsx_runtime3.jsx)("li", { "aria-current": page === currentPage ? "page" : void 0, children: renderPaginationButton({
    className: twMerge(theme2.pages.selector.base, currentPage === page && theme2.pages.selector.active),
    active: page === currentPage,
    onClick: () => onPageChange(page),
    children: page
  }) }, page)), (0, import_jsx_runtime3.jsx)("li", { children: (0, import_jsx_runtime3.jsxs)(PaginationNavigation, { className: twMerge(theme2.pages.next.base, showIcon && theme2.pages.showIcon), onClick: goToNextPage, disabled: currentPage === totalPages, children: [nextLabel, showIcon && (0, import_jsx_runtime3.jsx)(HiChevronRight, { "aria-hidden": true, className: theme2.pages.next.icon })] }) })] })] });
};
...
"use client";
var TableBodyContext = (0, import_react3.createContext)(void 0);
function useTableBodyContext() {
  const context = (0, import_react3.useContext)(TableBodyContext);
  if (!context) {
...
"use client";
var TableContext = (0, import_react4.createContext)(void 0);
function useTableContext() {
  const context = (0, import_react4.useContext)(TableContext);
  if (!context) {
...
var TableBody = ({ children, className, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime4.jsx)(TableBodyContext.Provider, { value: { theme: theme2 }, children: (0, import_jsx_runtime4.jsx)("tbody", { className: twMerge(theme2.base, className), ...props, children }) });
};
...
var TableCell = ({ children, className, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime5.jsx)("td", { className: twMerge(theme2.base, className), ...props, children });
};
...
"use client";
var TableHeadContext = (0, import_react5.createContext)(void 0);
function useTableHeadContext() {
  const context = (0, import_react5.useContext)(TableHeadContext);
  if (!context) {
...
var TableHead = ({ children, className, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime6.jsx)(TableHeadContext.Provider, { value: { theme: theme2 }, children: (0, import_jsx_runtime6.jsx)("thead", { className: twMerge(theme2.base, className), ...props, children: (0, import_jsx_runtime6.jsx)("tr", { children }) }) });
};
...
var TableHeadCell = ({ children, className, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime7.jsx)("th", { className: twMerge(theme2.base, className), ...props, children });
};
...
var TableRow = ({ children, className, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime8.jsx)("tr", { "data-testid": "table-row-element", className: twMerge(theme2.base, striped && theme2.striped, hoverable && theme2.hovered, className), ...props, children });
};
...
var TableComponent = ({ children, className, striped, hoverable, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime9.jsx)("div", { "data-testid": "table-element", className: twMerge(theme2.root.wrapper), children: (0, import_jsx_runtime9.jsxs)(TableContext.Provider, { value: { theme: theme2, striped, hoverable }, children: [(0, import_jsx_runtime9.jsx)("div", { className: twMerge(theme2.root.shadow, className) }), (0, import_jsx_runtime9.jsx)("table", { className: twMerge(theme2.root.base, className), ...props, children })] }) });
};
...
"use client";
var AccordionPanelContext = (0, import_react6.createContext)(void 0);
function useAccordionContext() {
  const context = (0, import_react6.useContext)(AccordionPanelContext);
  if (!context) {
...
var AccordionContent = ({ children, className, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime10.jsx)("div", { className: twMerge(theme2.base, className), "data-testid": "flowbite-accordion-content", hidden: !isOpen, ...props, children });
};
...
var AccordionPanel = ({ children, ...props }) => {
  ...
  const [isOpen, setOpen] = (0, import_react7.useState)(props.isOpen);
  const provider = alwaysOpen ? {
    ...props,
    isOpen,
    setOpen: () => setOpen(!isOpen)
  } : props;
  return (0, import_jsx_runtime11.jsx)(AccordionPanelContext.Provider, { value: provider, children });
};
...
var AccordionComponent = ({ alwaysOpen = false, arrowIcon = HiChevronDown, children, flush = false, collapseAll = false, className, theme: customTheme = {}, ...props }) => {
  const [isOpen, setOpen] = (0, import_react8.useState)(collapseAll ? -1 : 0);
  const panels = (0, import_react8.useMemo)(() => import_react8.Children.map(children, (child, i2) => (0, import_react8.cloneElement)(child, {
    alwaysOpen,
    arrowIcon,
    flush,
    isOpen: isOpen === i2,
  ...
  return (0, import_jsx_runtime13.jsx)("div", { className: twMerge(theme2.base, theme2.flush[flush ? "on" : "off"], className), "data-testid": "flowbite-accordion", ...props, children: panels });
};
...
var AvatarGroup = ({ children, className, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime14.jsx)("div", { "data-testid": "avatar-group-element", className: twMerge(theme2.base, className), ...props, children });
};
...
var AvatarGroupCounter = ({ className, href, theme: customTheme = {}, total, ...props }) => {
  ...
  return (0, import_jsx_runtime15.jsxs)("a", { href, className: twMerge(theme2.base, className), ...props, children: ["+", total] });
};
...
var AvatarComponent = ({ alt = "", bordered = false, children, className, color = "light", img, placeholderInitials = "", rounded = false, size: size3 = "md", stacked = false, status, statusPosition = "top-left", theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime16.jsxs)("div", { className: twMerge(theme2.root.base, className), "data-testid": "flowbite-avatar", ...props, children: [(0, import_jsx_runtime16.jsxs)("div", { className: "relative", children: [img ? typeof img === "string" ? (0, import_jsx_runtime16.jsx)("img", { alt, src: img, ...imgProps }) : img({ alt, ...imgProps }) : placeholderInitials ? (0, import_jsx_runtime16.jsx)("div", { className: twMerge(theme2.root.img.off, theme2.root.initials.base, stacked && theme2.root.stacked, bordered && theme2.root.bordered, bordered && theme2.root.color[color], theme2.root.size[size3], rounded && theme2.root.rounded), "data-testid": "flowbite-avatar-initials-placeholder", children: (0, import_jsx_runtime16.jsx)("span", { className: twMerge(theme2.root.initials.text), "data-testid": "flowbite-avatar-initials-placeholder-text", children: placeholderInitials }) }) : (0, import_jsx_runtime16.jsx)("div", { className: twMerge(imgClassName, theme2.root.img.off), "data-testid": "flowbite-avatar-img", children: (0, import_jsx_runtime16.jsx)("svg", { className: theme2.root.img.placeholder, fill: "currentColor", viewBox: "0 0 20 20", xmlns: "http://www.w3.org/2000/svg", children: (0, import_jsx_runtime16.jsx)("path", { fillRule: "evenodd", d: "M10 9a3 3 0 100-6 3 3 0 000 6zm-7 9a7 7 0 1114 0H3z", clipRule: "evenodd" }) }) }), status && (0, import_jsx_runtime16.jsx)("span", { "data-testid": "flowbite-avatar-status", className: twMerge(theme2.root.status.base, theme2.root.status[status], theme2.root.statusPosition[statusPosition]) })] }), children && (0, import_jsx_runtime16.jsx)("div", { children })] });
};
...
var Badge = ({ children, color = "info", href, icon: Icon, size: size3 = "xs", className, theme: customTheme = {}, ...props }) => {
  ...
  const Content = () => (0, import_jsx_runtime17.jsxs)("span", { className: twMerge(theme2.root.base, theme2.root.color[color], theme2.root.size[size3], theme2.icon[Icon ? "on" : "off"], className), "data-testid": "flowbite-badge", ...props, children: [Icon && (0, import_jsx_runtime17.jsx)(Icon, { "aria-hidden": true, className: theme2.icon.size[size3], "data-testid": "flowbite-badge-icon" }), children && (0, import_jsx_runtime17.jsx)("span", { children })] });
  return href ? (0, import_jsx_runtime17.jsx)("a", { className: theme2.root.href, href, children: (0, import_jsx_runtime17.jsx)(Content, {}) }) : (0, import_jsx_runtime17.jsx)(Content, {});
};
...
var genericForwardRef = import_react9.forwardRef;
...
var Spinner = ({ className, color = "info", light, size: size3 = "md", theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime18.jsx)("span", { role: "status", ...props, children: (0, import_jsx_runtime18.jsxs)("svg", { fill: "none", viewBox: "0 0 100 101", className: twMerge(theme2.base, theme2.color[color], theme2.light[light ? "on" : "off"].base, theme2.light[light ? "on" : "off"].color[color], theme2.size[size3], className), children: [(0, import_jsx_runtime18.jsx)("path", { d: "M100 50.5908C100 78.2051 77.6142 100.591 50 100.591C22.3858 100.591 0 78.2051 0 50.5908C0 22.9766 22.3858 0.59082 50 0.59082C77.6142 0.59082 100 22.9766 100 50.5908ZM9.08144 50.5908C9.08144 73.1895 27.4013 91.5094 50 91.5094C72.5987 91.5094 90.9186 73.1895 90.9186 50.5908C90.9186 27.9921 72.5987 9.67226 50 9.67226C27.4013 9.67226 9.08144 27.9921 9.08144 50.5908Z", fill: "currentColor" }), (0, import_jsx_runtime18.jsx)("path", { d: "M93.9676 39.0409C96.393 38.4038 97.8624 35.9116 97.0079 33.5539C95.2932 28.8227 92.871 24.3692 89.8167 20.348C85.8452 15.1192 80.8826 10.7238 75.2124 7.41289C69.5422 4.10194 63.2754 1.94025 56.7698 1.05124C51.7666 0.367541 46.6976 0.446843 41.7345 1.27873C39.2613 1.69328 37.813 4.19778 38.4501 6.62326C39.0873 9.04874 41.5694 10.4717 44.0505 10.1071C47.8511 9.54855 51.7191 9.52689 55.5402 10.0491C60.8642 10.7766 65.9928 12.5457 70.6331 15.2552C75.2735 17.9648 79.3347 21.5619 82.5849 25.841C84.9175 28.9121 86.7997 32.2913 88.1811 35.8758C89.083 38.2158 91.5421 39.6781 93.9676 39.0409Z", fill: "currentFill" })] }) });
};
...
var ButtonBaseComponent = ({ children, as: Component, href, type = "button", ...props }, ref) => {
  ...
  return (0, import_react10.createElement)(BaseComponent, { ref, href, type, ...props }, children);
};
...
var ButtonGroup = ({ children, className, outline, pill, theme: customTheme = {}, ...props }) => {
  const items = (0, import_react11.useMemo)(() => import_react11.Children.map(children, (child, index3) => (0, import_react11.cloneElement)(child, {
    outline,
    pill,
  ...
  return (0, import_jsx_runtime19.jsx)("div", { className: twMerge(theme2.base, className), role: "group", ...props, children: items });
};
...
var BannerCollapseButton = ({ children, ...props }) => {
  ...
  return (0, import_jsx_runtime21.jsx)(Button, { onClick, ...props, children });
};
BannerCollapseButton.displayName = "Banner.CollapseButton";

// node_modules/flowbite-react/lib/esm/components/Banner/Banner.js
var BannerComponent = ({ children, ...props }) => {
  return (0, import_jsx_runtime22.jsx)("div", { "data-testid": "flowbite-banner", role: "banner", tabIndex: -1, ...props, children });
};
...
var Blockquote = ({ children, className, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime23.jsx)("blockquote", { className: twMerge(theme2.root.base, className), "data-testid": "flowbite-blockquote", ...props, children });
};
...
var BreadcrumbItem = (0, import_react12.forwardRef)(({ children, className, href, icon: Icon, theme: customTheme = {}, ...props }, ref) => {
  const isLink = typeof href !== "undefined";
  const Component = isLink ? "a" : "span";
  const theme2 = mergeDeep(getTheme().breadcrumb.item, customTheme);
  return (0, import_jsx_runtime24.jsxs)("li", { className: twMerge(theme2.base, className), ...props, children: [(0, import_jsx_runtime24.jsx)(HiOutlineChevronRight, { "aria-hidden": true, className: theme2.chevron, "data-testid": "flowbite-breadcrumb-separator" }), (0, import_jsx_runtime24.jsxs)(Component, { ref, className: theme2.href[isLink ? "on" : "off"], "data-testid": "flowbite-breadcrumb-item", href, children: [Icon && (0, import_jsx_runtime24.jsx)(Icon, { "aria-hidden": true, className: theme2.icon }), children] })] });
});
...
var BreadcrumbComponent = ({ children, className, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime25.jsx)("nav", { "aria-label": "Breadcrumb", className: twMerge(theme2.base, className), ...props, children: (0, import_jsx_runtime25.jsx)("ol", { className: theme2.list, children }) });
};
...
var p = function(e2) {
  function o2(n2) {
    ...
    }, o3.container = import_react13.default.createRef(), o3.onEndScroll = l(o3.onEndScroll, 300), o3.scrolling = false, o3.started = false, o3.pressed = false, o3.internal = false, o3.getRef = o3.getRef.bind(o3), o3;
  }
  return function(t2, e3) {
    ...
    return import_react13.default.createElement(a2, { className: i(r2, this.pressed && o3, c({ dragging: this.pressed, "hide-scrollbars": l2, "native-scroll": this.isMobile })), style: s2, ref: this.getRef, onScroll: this.onScroll }, n2);
...
var Carousel = ({ children, indicators = true, leftControl, rightControl, slide = true, draggable = true, slideInterval, className, theme: customTheme = {}, onSlideChange = null, pauseOnHover = false, ...props }) => {
  ...
  const carouselContainer = (0, import_react14.useRef)(null);
  const [activeItem, setActiveItem] = (0, import_react14.useState)(0);
  ...
  const didMountRef = (0, import_react14.useRef)(false);
  const items = (0, import_react14.useMemo)(() => import_react14.Children.map(children, (child) => (0, import_react14.cloneElement)(child, {
    className: twMerge(theme2.item.base, child.props.className)
  })), [children, theme2.item.base]);
  const navigateTo = (0, import_react14.useCallback)((item) => () => {
    if (!items)
      return;
  ...
  const setHoveringTrue = (0, import_react14.useCallback)(() => setIsHovering(true), [setIsHovering]);
  const setHoveringFalse = (0, import_react14.useCallback)(() => setIsHovering(false), [setIsHovering]);
  return (0, import_jsx_runtime27.jsxs)("div", { className: twMerge(theme2.root.base, className), "data-testid": "carousel", onMouseEnter: setHoveringTrue, onMouseLeave: setHoveringFalse, onTouchStart: setHoveringTrue, onTouchEnd: setHoveringFalse, ...props, children: [(0, import_jsx_runtime27.jsx)(index_es_default, { className: twMerge(theme2.scrollContainer.base, (isDeviceMobile || !isDragging) && theme2.scrollContainer.snap), draggingClassName: "cursor-grab", innerRef: carouselContainer, onEndScroll: handleDragging(false), onStartScroll: handleDragging(draggable), vertical: false, horizontal: draggable, children: items?.map((item, index3) => (0, import_jsx_runtime27.jsx)("div", { className: theme2.item.wrapper[draggable ? "on" : "off"], "data-active": activeItem === index3, "data-testid": "carousel-item", children: item }, index3)) }), indicators && (0, import_jsx_runtime27.jsx)("div", { className: theme2.indicators.wrapper, children: items?.map((_, index3) => (0, import_jsx_runtime27.jsx)("button", { className: twMerge(theme2.indicators.base, theme2.indicators.active[index3 === activeItem ? "on" : "off"]), onClick: navigateTo(index3), "data-testid": "carousel-indicator", "aria-label": `Slide ${index3 + 1}` }, index3)) }), items && (0, import_jsx_runtime27.jsxs)(import_jsx_runtime27.Fragment, { children: [(0, import_jsx_runtime27.jsx)("div", { className: theme2.root.leftControl, children: (0, import_jsx_runtime27.jsx)("button", { className: "group", "data-testid": "carousel-left-control", onClick: navigateTo(activeItem - 1), type: "button", "aria-label": "Previous slide", children: leftControl ? leftControl : (0, import_jsx_runtime27.jsx)(DefaultLeftControl, { theme: customTheme }) }) }), (0, import_jsx_runtime27.jsx)("div", { className: theme2.root.rightControl, children: (0, import_jsx_runtime27.jsx)("button", { className: "group", "data-testid": "carousel-right-control", onClick: navigateTo(activeItem + 1), type: "button", "aria-label": "Next slide", children: rightControl ? rightControl : (0, import_jsx_runtime27.jsx)(DefaultRightControl, { theme: customTheme }) }) })] })] });
};
var DefaultLeftControl = ({ theme: customTheme = {} }) => {
  const theme2 = mergeDeep(getTheme().carousel, customTheme);
  return (0, import_jsx_runtime27.jsx)("span", { className: theme2.control.base, children: (0, import_jsx_runtime27.jsx)(HiOutlineChevronLeft, { className: theme2.control.icon }) });
};
var DefaultRightControl = ({ theme: customTheme = {} }) => {
  const theme2 = mergeDeep(getTheme().carousel, customTheme);
  return (0, import_jsx_runtime27.jsx)("span", { className: theme2.control.base, children: (0, import_jsx_runtime27.jsx)(HiOutlineChevronRight, { className: theme2.control.icon }) });
};
...
var Checkbox = (0, import_react15.forwardRef)(({ className, color = "default", theme: customTheme = {}, ...props }, ref) => {
  const theme2 = mergeDeep(getTheme().checkbox, customTheme);
  return (0, import_jsx_runtime28.jsx)("input", { ref, type: "checkbox", className: twMerge(theme2.root.base, theme2.root.color[color], className), ...props });
});
...
var useThemeMode = () => {
  const [mode, setMode] = (0, import_react18.useState)(getInitialMode(getThemeMode()));
...
var DarkThemeToggle = ({ className, theme: customTheme = {}, iconDark: IconDark = HiSun, iconLight: IconLight = HiMoon, ...props }) => {
  ...
  return (0, import_jsx_runtime29.jsxs)("button", { type: "button", "aria-label": "Toggle dark mode", "data-testid": "dark-theme-toggle", className: twMerge(theme2.root.base, className), onClick: toggleMode, ...props, children: [(0, import_jsx_runtime29.jsx)(IconDark, { "aria-label": "Currently dark mode", "data-active": isMounted && computedMode === "dark", className: twMerge(theme2.root.icon, "hidden dark:block") }), (0, import_jsx_runtime29.jsx)(IconLight, { "aria-label": "Currently light mode", "data-active": isMounted && computedMode === "light", className: twMerge(theme2.root.icon, "dark:hidden") })] });
};
...
var HelperText = ({ children, className, color = "default", theme: customTheme = {}, value, ...props }) => {
  ...
  return (0, import_jsx_runtime30.jsx)("p", { className: twMerge(theme2.root.base, theme2.root.colors[color], className), ...props, children: value ?? children ?? "" });
};
HelperText.displayName = "HelperText";

// node_modules/flowbite-react/lib/esm/components/TextInput/TextInput.js
var TextInput = (0, import_react19.forwardRef)(({ addon, className, color = "gray", helperText, icon: Icon, rightIcon: RightIcon, shadow, sizing = "md", theme: customTheme = {}, ...props }, ref) => {
  const theme2 = mergeDeep(getTheme().textInput, customTheme);
  return (0, import_jsx_runtime31.jsxs)(import_jsx_runtime31.Fragment, { children: [(0, import_jsx_runtime31.jsxs)("div", { className: twMerge(theme2.base, className), children: [addon && (0, import_jsx_runtime31.jsx)("span", { className: theme2.addon, children: addon }), (0, import_jsx_runtime31.jsxs)("div", { className: theme2.field.base, children: [Icon && (0, import_jsx_runtime31.jsx)("div", { className: theme2.field.icon.base, children: (0, import_jsx_runtime31.jsx)(Icon, { className: theme2.field.icon.svg }) }), RightIcon && (0, import_jsx_runtime31.jsx)("div", { "data-testid": "right-icon", className: theme2.field.rightIcon.base, children: (0, import_jsx_runtime31.jsx)(RightIcon, { className: theme2.field.rightIcon.svg }) }), (0, import_jsx_runtime31.jsx)("input", { className: twMerge(theme2.field.input.base, theme2.field.input.colors[color], theme2.field.input.sizes[sizing], theme2.field.input.withIcon[Icon ? "on" : "off"], theme2.field.input.withRightIcon[RightIcon ? "on" : "off"], theme2.field.input.withAddon[addon ? "on" : "off"], theme2.field.input.withShadow[shadow ? "on" : "off"]), ...props, ref })] })] }), helperText && (0, import_jsx_runtime31.jsx)(HelperText, { color, children: helperText })] });
});
...
"use client";
var DatepickerContext = (0, import_react20.createContext)(void 0);
function useDatePickerContext() {
  const context = (0, import_react20.useContext)(DatepickerContext);
  if (!context) {
...
var DatepickerViewsDays = ({ theme: customTheme = {} }) => {
  ...
  return (0, import_jsx_runtime32.jsxs)(import_jsx_runtime32.Fragment, { children: [(0, import_jsx_runtime32.jsx)("div", { className: theme2.header.base, children: weekDays.map((day, index3) => (0, import_jsx_runtime32.jsx)("span", { className: theme2.header.title, children: day }, index3)) }), (0, import_jsx_runtime32.jsx)("div", { className: theme2.items.base, children: [...Array(42)].map((_date, index3) => {
...
var DatepickerViewsMonth = ({ theme: customTheme = {} }) => {
  ...
  return (0, import_jsx_runtime34.jsx)("div", { className: theme2.items.base, children: [...Array(12)].map((_month, index3) => {
    ...
    return (0, import_jsx_runtime34.jsx)("button", { disabled: isDisabled, type: "button", className: twMerge(theme2.items.item.base, isSelected && theme2.items.item.selected, isDisabled && theme2.items.item.disabled), onClick: () => {
      if (isDisabled)
        return;
      setViewDate(newDate);
      setView(Views.Days);
...
var DatepickerViewsYears = ({ theme: customTheme = {} }) => {
  ...
  return (0, import_jsx_runtime35.jsx)("div", { className: theme2.items.base, children: [...Array(12)].map((_year, index3) => {
    ...
    const isSelected = isDateEqual(selectedDate, newDate);
    const isDisabled = !isDateInRange(newDate, minDate, maxDate);
    return (0, import_jsx_runtime35.jsx)("button", { disabled: isDisabled, type: "button", className: twMerge(theme2.items.item.base, isSelected && theme2.items.item.selected, isDisabled && theme2.items.item.disabled), onClick: () => {
      if (isDisabled)
        return;
      setViewDate(newDate);
...
var Datepicker = ({
  ...
  const [isOpen, setIsOpen] = (0, import_react21.useState)(open);
  const [view, setView] = (0, import_react21.useState)(Views.Days);
  const [selectedDate, setSelectedDate] = (0, import_react21.useState)(defaultDate);
  const [viewDate, setViewDate] = (0, import_react21.useState)(defaultDate);
  const inputRef = (0, import_react21.useRef)(null);
  const datepickerRef = (0, import_react21.useRef)(null);
  ...
  const renderView = (type) => {
    switch (type) {
      case Views.Decades:
        return (0, import_jsx_runtime36.jsx)(DatepickerViewsDecades, { theme: theme2.views.decades });
      case Views.Years:
        return (0, import_jsx_runtime36.jsx)(DatepickerViewsYears, { theme: theme2.views.years });
      case Views.Months:
        return (0, import_jsx_runtime36.jsx)(DatepickerViewsMonth, { theme: theme2.views.months });
      case Views.Days:
      default:
        return (0, import_jsx_runtime36.jsx)(DatepickerViewsDays, { theme: theme2.views.days });
    }
  };
  const getNextView = () => {
    switch (view) {
  ...
  return (0, import_jsx_runtime36.jsx)(DatepickerContext.Provider, { value: {
    theme: theme2,
    language,
    minDate,
    maxDate,
    ...
    setSelectedDate,
    changeSelectedDate
  }, children: (0, import_jsx_runtime36.jsxs)("div", { className: twMerge(theme2.root.base, className), children: [!inline3 && (0, import_jsx_runtime36.jsx)(TextInput, { theme: theme2.root.input, icon: HiCalendar, ref: inputRef, onFocus: () => {
    if (!isDateEqual(viewDate, selectedDate)) {
      setViewDate(selectedDate);
    }
    setIsOpen(true);
  }, value: selectedDate && getFormattedDate(language, selectedDate), readOnly: true, ...props }), (isOpen || inline3) && (0, import_jsx_runtime36.jsx)("div", { ref: datepickerRef, className: twMerge(theme2.popup.root.base, inline3 && theme2.popup.root.inline), children: (0, import_jsx_runtime36.jsxs)("div", { className: theme2.popup.root.inner, children: [(0, import_jsx_runtime36.jsxs)("div", { className: theme2.popup.header.base, children: [title && (0, import_jsx_runtime36.jsx)("div", { className: theme2.popup.header.title, children: title }), (0, import_jsx_runtime36.jsxs)("div", { className: theme2.popup.header.selectors.base, children: [(0, import_jsx_runtime36.jsx)("button", { type: "button", className: twMerge(theme2.popup.header.selectors.button.base, theme2.popup.header.selectors.button.prev), onClick: () => setViewDate(getViewDatePage(view, viewDate, -1)), children: (0, import_jsx_runtime36.jsx)(HiArrowLeft, {}) }), (0, import_jsx_runtime36.jsx)("button", { type: "button", className: twMerge(theme2.popup.header.selectors.button.base, theme2.popup.header.selectors.button.view), onClick: () => setView(getNextView()), children: getViewTitle() }), (0, import_jsx_runtime36.jsx)("button", { type: "button", className: twMerge(theme2.popup.header.selectors.button.base, theme2.popup.header.selectors.button.next), onClick: () => setViewDate(getViewDatePage(view, viewDate, 1)), children: (0, import_jsx_runtime36.jsx)(HiArrowRight, {}) })] })] }), (0, import_jsx_runtime36.jsx)("div", { className: theme2.popup.view.base, children: renderView(view) }), (showClearButton || showTodayButton) && (0, import_jsx_runtime36.jsxs)("div", { className: theme2.popup.footer.base, children: [showTodayButton && (0, import_jsx_runtime36.jsx)("button", { type: "button", className: twMerge(theme2.popup.footer.button.base, theme2.popup.footer.button.today), onClick: () => {
    const today = /* @__PURE__ */ new Date();
    changeSelectedDate(today, true);
    setViewDate(today);
  }, children: labelTodayButton }), showClearButton && (0, import_jsx_runtime36.jsx)("button", { type: "button", className: twMerge(theme2.popup.footer.button.base, theme2.popup.footer.button.clear), onClick: () => {
...
var FloatingListContext = /* @__PURE__ */ React4.createContext({
  register: () => {
  },
  unregister: () => {
  },
...
function FloatingList(_ref) {
  ...
  return /* @__PURE__ */ React4.createElement(FloatingListContext.Provider, {
...
var FocusGuard = /* @__PURE__ */ React4.forwardRef(function FocusGuard2(props, ref) {
  ...
  return /* @__PURE__ */ React4.createElement("span", _extends({}, props, restProps));
});
...
function FloatingPortal(_ref) {
  ...
  return /* @__PURE__ */ React4.createElement(PortalContext.Provider, {
    value: React4.useMemo(() => ({
      preserveTabOrder,
      beforeOutsideRef,
      afterOutsideRef,
  ...
  }, shouldRenderGuards && portalNode && /* @__PURE__ */ React4.createElement(FocusGuard, {
    "data-type": "outside",
  ...
  }), shouldRenderGuards && portalNode && /* @__PURE__ */ React4.createElement("span", {
    "aria-owns": portalNode.id,
    style: HIDDEN_STYLES
  }), portalNode && /* @__PURE__ */ (0, import_react_dom3.createPortal)(children, portalNode), shouldRenderGuards && portalNode && /* @__PURE__ */ React4.createElement(FocusGuard, {
    "data-type": "outside",
    ref: afterOutsideRef,
    onFocus: (event) => {
      if (isOutsideEvent(event, portalNode)) {
...
var VisuallyHiddenDismiss = /* @__PURE__ */ React4.forwardRef(function VisuallyHiddenDismiss2(props, ref) {
  return /* @__PURE__ */ React4.createElement("button", _extends({}, props, {
    type: "button",
    ref,
    tabIndex: -1,
    style: HIDDEN_STYLES
...
function FloatingFocusManager(props) {
  ...
  function renderDismissButton(location) {
    ...
    return /* @__PURE__ */ React4.createElement(VisuallyHiddenDismiss, {
      ref: location === "start" ? startDismissButtonRef : endDismissButtonRef,
      onClick: (event) => onOpenChange(false, event.nativeEvent)
    }, typeof visuallyHiddenDismiss === "string" ? visuallyHiddenDismiss : "Dismiss");
  }
  const shouldRenderGuards = !disabled && guards && (isInsidePortal || modal);
  return /* @__PURE__ */ React4.createElement(React4.Fragment, null, shouldRenderGuards && /* @__PURE__ */ React4.createElement(FocusGuard, {
    "data-type": "inside",
  ...
  }), !isUntrappedTypeableCombobox && renderDismissButton("start"), children, renderDismissButton("end"), shouldRenderGuards && /* @__PURE__ */ React4.createElement(FocusGuard, {
    "data-type": "inside",
...
var FloatingOverlay = /* @__PURE__ */ React4.forwardRef(function FloatingOverlay2(_ref, ref) {
  let {
    lockScroll = false,
    ...rest
  } = _ref;
  ...
  return /* @__PURE__ */ React4.createElement("div", _extends({
    ref
  }, rest, {
    style: {
      position: "fixed",
...
var DropdownDivider = ({ className, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime37.jsx)("div", { className: twMerge(theme2, className), ...props });
};
...
var DropdownHeader = ({ children, className, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime38.jsxs)(import_jsx_runtime38.Fragment, { children: [(0, import_jsx_runtime38.jsx)("div", { className: twMerge(theme2, className), ...props, children }), (0, import_jsx_runtime38.jsx)(DropdownDivider, {})] });
};
...
var DropdownItem = ({ children, className, icon: Icon, onClick, theme: customTheme = {}, ...props }) => {
  ...
  const theirProps = props;
  return (0, import_jsx_runtime39.jsx)("li", { role: "menuitem", className: theme2.container, children: (0, import_jsx_runtime39.jsxs)(ButtonBase, { ref, className: twMerge(theme2.base, className), ...theirProps, ...getItemProps({
    onClick: () => {
      onClick && onClick();
      dismissOnClick && handleSelect(null);
    }
  }), tabIndex: isActive ? 0 : -1, children: [Icon && (0, import_jsx_runtime39.jsx)(Icon, { className: theme2.icon }), children] }) });
};
...
var Trigger = ({ refs, children, inline: inline3, theme: theme2, disabled, setButtonWidth, getReferenceProps, renderTrigger, ...buttonProps }) => {
  ...
  return inline3 ? (0, import_jsx_runtime40.jsx)("button", { type: "button", ref: refs.setReference, className: theme2?.inlineWrapper, disabled, ...a11yProps, children }) : (0, import_jsx_runtime40.jsx)(Button, { ...buttonProps, disabled, type: "button", ref: refs.setReference, ...a11yProps, children });
};
var DropdownComponent = ({ children, className, dismissOnClick = true, theme: customTheme = {}, renderTrigger, ...props }) => {
  ...
  const handleSelect = (0, import_react29.useCallback)((index3) => {
    setSelectedIndex(index3);
    setOpen(false);
  }, []);
  const handleTypeaheadMatch = (0, import_react29.useCallback)((index3) => {
    if (open) {
  ...
  return (0, import_jsx_runtime40.jsxs)(DropdownContext.Provider, { value: { theme: theme2, activeIndex, dismissOnClick, getItemProps, handleSelect }, children: [(0, import_jsx_runtime40.jsxs)(Trigger, { ...buttonProps, refs, inline: inline3, theme: theme2, "data-testid": dataTestId, className: twMerge(theme2.floating.target, buttonProps.className), setButtonWidth, getReferenceProps, renderTrigger, children: [label, arrowIcon && (0, import_jsx_runtime40.jsx)(Icon, { className: theme2.arrowIcon })] }), open && (0, import_jsx_runtime40.jsx)(FloatingFocusManager, { context, modal: false, children: (0, import_jsx_runtime40.jsx)("div", { ref: refs.setFloating, style: { ...floatingStyles, minWidth: buttonWidth }, "data-testid": "flowbite-dropdown", "aria-expanded": open, ...getFloatingProps({
  ...
  }), children: (0, import_jsx_runtime40.jsx)(FloatingList, { elementsRef, labelsRef, children: (0, import_jsx_runtime40.jsx)("ul", { className: theme2.content, tabIndex: -1, children }) }) }) })] });
};
...
var FileInput = (0, import_react30.forwardRef)(({ className, color = "gray", helperText, sizing = "md", theme: customTheme = {}, ...props }, ref) => {
  const theme2 = mergeDeep(getTheme().fileInput, customTheme);
  return (0, import_jsx_runtime41.jsxs)(import_jsx_runtime41.Fragment, { children: [(0, import_jsx_runtime41.jsx)("div", { className: twMerge(theme2.root.base, className), children: (0, import_jsx_runtime41.jsx)("div", { className: theme2.field.base, children: (0, import_jsx_runtime41.jsx)("input", { className: twMerge(theme2.field.input.base, theme2.field.input.colors[color], theme2.field.input.sizes[sizing]), ...props, type: "file", ref }) }) }), helperText && (0, import_jsx_runtime41.jsx)(HelperText, { color, children: helperText })] });
});
...
var FloatingLabel = (0, import_react31.forwardRef)(({ label, helperText, color = "default", sizing = "md", variant, disabled = false, theme: customTheme = {}, className, ...props }, ref) => {
  const randomId = (0, import_react31.useId)();
  const theme2 = mergeDeep(getTheme().floatingLabel, customTheme);
  return (0, import_jsx_runtime42.jsxs)("div", { children: [(0, import_jsx_runtime42.jsxs)("div", { className: twMerge("relative", variant === "standard" ? "z-0" : ""), children: [(0, import_jsx_runtime42.jsx)("input", { type: "text", id: props.id ? props.id : "floatingLabel" + randomId, "aria-describedby": "outlined_success_help", className: twMerge(theme2.input[color][variant][sizing], className), placeholder: " ", "data-testid": "floating-label", disabled, ...props, ref }), (0, import_jsx_runtime42.jsx)("label", { htmlFor: props.id ? props.id : "floatingLabel" + randomId, className: twMerge(theme2.label[color][variant][sizing], className), children: label })] }), (0, import_jsx_runtime42.jsx)("p", { id: "outlined_helper_text" + randomId, className: twMerge(theme2.helperText[color], className), children: helperText })] });
});
...
function ThemeInit({ mode, theme: theme2 }) {
  return (0, import_jsx_runtime43.jsxs)(import_jsx_runtime43.Fragment, { children: [(0, import_jsx_runtime43.jsx)(ThemeModeInit, { mode }), (0, import_jsx_runtime43.jsx)(ThemeServerInit, { theme: theme2 }), (0, import_jsx_runtime43.jsx)(ThemeClientInit, { theme: theme2 })] });
}

// node_modules/flowbite-react/lib/esm/components/Flowbite/Flowbite.js
var Flowbite = ({ children, theme: theme2 }) => {
  return (0, import_jsx_runtime44.jsxs)(import_jsx_runtime44.Fragment, { children: [(0, import_jsx_runtime44.jsx)(ThemeInit, { mode: theme2?.mode, theme: theme2?.theme }), children] });
};
...
var FooterBrand = ({ alt, className, children, href, name, src, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime45.jsx)("div", { children: href ? (0, import_jsx_runtime45.jsxs)("a", { "data-testid": "flowbite-footer-brand", href, className: twMerge(theme2.base, className), ...props, children: [(0, import_jsx_runtime45.jsx)("img", { alt, src, className: theme2.img }), (0, import_jsx_runtime45.jsx)("span", { "data-testid": "flowbite-footer-brand-span", className: theme2.span, children: name }), children] }) : (0, import_jsx_runtime45.jsx)("img", { alt, "data-testid": "flowbite-footer-brand", src, className: twMerge(theme2.img, className), ...props }) });
};
...
var FooterCopyright = ({ by, className, href, theme: customTheme = {}, year, ...props }) => {
  ...
  return (0, import_jsx_runtime46.jsxs)("div", { "data-testid": "flowbite-footer-copyright", className: twMerge(theme2.base, className), ...props, children: ["\xA9 ", year, href ? (0, import_jsx_runtime46.jsx)("a", { href, className: theme2.href, children: by }) : (0, import_jsx_runtime46.jsx)("span", { "data-testid": "flowbite-footer-copyright-span", className: theme2.span, children: by })] });
};
...
var FooterDivider = ({ className, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime47.jsx)("hr", { "data-testid": "footer-divider", className: twMerge(theme2.base, className), ...props });
};
...
var FooterIcon = ({ ariaLabel, className, href, icon: Icon, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime48.jsx)("div", { children: href ? (0, import_jsx_runtime48.jsx)("a", { "aria-label": ariaLabel, "data-testid": "flowbite-footer-icon", href, className: twMerge(theme2.base, className), ...props, children: (0, import_jsx_runtime48.jsx)(Icon, { className: theme2.size }) }) : (0, import_jsx_runtime48.jsx)(Icon, { "data-testid": "flowbite-footer-icon", className: theme2.size, ...props }) });
};
...
var FooterLink = ({ as: Component = "a", children, className, href, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime49.jsx)("li", { className: twMerge(theme2.base, className), children: (0, import_jsx_runtime49.jsx)(Component, { href, className: theme2.href, ...props, children }) });
};
...
var FooterLinkGroup = ({ children, className, col = false, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime50.jsx)("ul", { "data-testid": "footer-groupLink", className: twMerge(theme2.base, col && theme2.col, className), ...props, children });
};
...
var FooterTitle = ({ as: Component = "h2", className, theme: customTheme = {}, title, ...props }) => {
  ...
  return (0, import_jsx_runtime51.jsx)(Component, { "data-testid": "flowbite-footer-title", className: twMerge(theme2.base, className), ...props, children: title });
};
...
var FooterComponent = ({ bgDark = false, children, className, container = false, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime52.jsx)("footer", { "data-testid": "flowbite-footer", className: twMerge(theme2.root.base, bgDark && theme2.root.bgDark, container && theme2.root.container, className), ...props, children });
};
...
var Kbd = ({ children, className, icon: Icon, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime53.jsxs)("span", { className: twMerge(theme2.root.base, className), "data-testid": "flowbite-kbd", ...props, children: [Icon && (0, import_jsx_runtime53.jsx)(Icon, { className: theme2.root.icon, "data-testid": "flowbite-kbd-icon" }), children] });
};
Kbd.displayName = "Kbd";
...
var Label = ({ children, className, color = "default", disabled = false, theme: customTheme = {}, value, ...props }) => {
  ...
  return (0, import_jsx_runtime54.jsx)("label", { className: twMerge(theme2.root.base, theme2.root.colors[color], disabled && theme2.root.disabled, className), "data-testid": "flowbite-label", ...props, children: value ?? children ?? "" });
};
...
var ListItem = ({ children, className, theme: customTheme = {} }) => {
  ...
  return (0, import_jsx_runtime55.jsx)("li", { className: twMerge(theme2.base, className), children });
};
...
var ListComponent = ({ children, className, unstyled, nested, ordered, horizontal, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime56.jsx)(Component, { className: twMerge(theme2.root.base, theme2.root.ordered[ordered ? "on" : "off"], unstyled && theme2.root.unstyled, nested && theme2.root.nested, horizontal && theme2.root.horizontal, className), ...props, children });
};
...
var ListGroupItem = ({ active: isActive, children, className, href, icon: Icon, onClick, theme: customTheme = {}, disabled, ...props }) => {
  ...
  return (0, import_jsx_runtime57.jsx)("li", { className: twMerge(theme2.base, className), children: (0, import_jsx_runtime57.jsxs)(Component, { href, onClick, type: isLink ? void 0 : "button", disabled, className: twMerge(theme2.link.active[isActive ? "on" : "off"], theme2.link.disabled[disabled ? "on" : "off"], theme2.link.base, theme2.link.href[isLink ? "on" : "off"]), ...props, children: [Icon && (0, import_jsx_runtime57.jsx)(Icon, { "aria-hidden": true, "data-testid": "flowbite-list-group-item-icon", className: theme2.link.icon }), children] }) });
};

// node_modules/flowbite-react/lib/esm/components/ListGroup/ListGroup.js
var ListGroupComponent = ({ children, className, theme: customTheme = {}, ...props }) => {
  const theme2 = mergeDeep(getTheme().listGroup, customTheme);
  return (0, import_jsx_runtime58.jsx)("ul", { className: twMerge(theme2.root.base, className), ...props, children });
};
...
var ModalBody = ({ children, className, theme: customTheme = {}, ...props }) => {
  ...
  const theme2 = mergeDeep(rootTheme.body, customTheme);
  return (0, import_jsx_runtime59.jsx)("div", { className: twMerge(theme2.base, popup && [theme2.popup], className), ...props, children });
};
...
var ModalFooter = ({ children, className, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime60.jsx)("div", { className: twMerge(theme2.base, !popup && theme2.popup, className), ...props, children });
};
...
var ModalHeader = ({ as: Component = "h3", children, className, theme: customTheme = {}, id, ...props }) => {
  ...
  return (0, import_jsx_runtime61.jsxs)("div", { className: twMerge(theme2.base, popup && theme2.popup, className), ...props, children: [(0, import_jsx_runtime61.jsx)(Component, { id: headerId, className: theme2.title, children }), (0, import_jsx_runtime61.jsx)("button", { "aria-label": "Close", className: theme2.close.base, type: "button", onClick: onClose, children: (0, import_jsx_runtime61.jsx)(HiOutlineX, { "aria-hidden": true, className: theme2.close.icon }) })] });
};

// node_modules/flowbite-react/lib/esm/components/Modal/Modal.js
"use client";
var ModalComponent = (0, import_react35.forwardRef)(({ children, className, dismissible = false, onClose, popup, position = "center", root, show, size: size3 = "2xl", theme: customTheme = {}, initialFocus, ...props }, theirRef) => {
  ...
  return (0, import_jsx_runtime62.jsx)(ModalContext.Provider, { value: { theme: theme2, popup, onClose, setHeaderId }, children: (0, import_jsx_runtime62.jsx)(FloatingPortal, { root, children: (0, import_jsx_runtime62.jsx)(FloatingOverlay, { lockScroll: true, "data-testid": "modal-overlay", className: twMerge(theme2.root.base, theme2.root.positions[position], show ? theme2.root.show.on : theme2.root.show.off, className), ...props, children: (0, import_jsx_runtime62.jsx)(FloatingFocusManager, { context, initialFocus, children: (0, import_jsx_runtime62.jsx)("div", { ref, ...getFloatingProps(props), "aria-labelledby": headerId, className: twMerge(theme2.content.base, theme2.root.sizes[size3]), children: (0, import_jsx_runtime62.jsx)("div", { className: theme2.content.inner, children }) }) }) }) }) });
});
...
"use client";
var NavbarContext = (0, import_react36.createContext)(void 0);
function useNavbarContext() {
  const context = (0, import_react36.useContext)(NavbarContext);
  if (!context) {
...
var NavbarBrand = ({ as: Component = "a", children, className, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime63.jsx)(Component, { className: twMerge(theme2.base, className), ...props, children });
};
...
var NavbarCollapse = ({ children, className, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime64.jsx)("div", { "data-testid": "flowbite-navbar-collapse", className: twMerge(theme2.base, theme2.hidden[!isOpen ? "on" : "off"], className), ...props, children: (0, import_jsx_runtime64.jsx)("ul", { className: theme2.list, children }) });
};
...
var NavbarLink = ({ active, as: Component = "a", disabled, children, className, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime65.jsx)("li", { children: (0, import_jsx_runtime65.jsx)(Component, { className: twMerge(theme2.base, active && theme2.active.on, !active && !disabled && theme2.active.off, theme2.disabled[disabled ? "on" : "off"], className), ...props, children }) });
};
...
var NavbarToggle = ({ barIcon: BarIcon = FaBars, className, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime66.jsxs)("button", { "data-testid": "flowbite-navbar-toggle", onClick: handleClick, className: twMerge(theme2.base, className), ...props, children: [(0, import_jsx_runtime66.jsx)("span", { className: "sr-only", children: "Open main menu" }), (0, import_jsx_runtime66.jsx)(BarIcon, { "aria-hidden": true, className: theme2.icon })] });
};

// node_modules/flowbite-react/lib/esm/components/Navbar/Navbar.js
"use client";
var NavbarComponent = ({ border, children, className, fluid = false, menuOpen, rounded, theme: customTheme = {}, ...props }) => {
  const [isOpen, setIsOpen] = (0, import_react37.useState)(menuOpen);
  const theme2 = mergeDeep(getTheme().navbar, customTheme);
  return (0, import_jsx_runtime67.jsx)(NavbarContext.Provider, { value: { theme: theme2, isOpen, setIsOpen }, children: (0, import_jsx_runtime67.jsx)("nav", { className: twMerge(theme2.root.base, theme2.root.bordered[border ? "on" : "off"], theme2.root.rounded[rounded ? "on" : "off"], className), ...props, children: (0, import_jsx_runtime67.jsx)("div", { className: twMerge(theme2.root.inner.base, theme2.root.inner.fluid[fluid ? "on" : "off"]), children }) }) });
};
...
var Progress = ({ className, color = "cyan", labelProgress = false, labelText = false, progress, progressLabelPosition = "inside", size: size3 = "md", textLabel = "progressbar", textLabelPosition = "inside", theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime68.jsx)(import_jsx_runtime68.Fragment, { children: (0, import_jsx_runtime68.jsxs)("div", { id, "aria-label": textLabel, "aria-valuenow": progress, role: "progressbar", ...props, children: [(textLabel && labelText && textLabelPosition === "outside" || progress > 0 && labelProgress && progressLabelPosition === "outside") && (0, import_jsx_runtime68.jsxs)("div", { className: theme2.label, "data-testid": "flowbite-progress-outer-label-container", children: [textLabel && labelText && textLabelPosition === "outside" && (0, import_jsx_runtime68.jsx)("span", { "data-testid": "flowbite-progress-outer-text-label", children: textLabel }), labelProgress && progressLabelPosition === "outside" && (0, import_jsx_runtime68.jsxs)("span", { "data-testid": "flowbite-progress-outer-progress-label", children: [progress, "%"] })] }), (0, import_jsx_runtime68.jsx)("div", { className: twMerge(theme2.base, theme2.size[size3], className), children: (0, import_jsx_runtime68.jsxs)("div", { style: { width: `${progress}%` }, className: twMerge(theme2.bar, theme2.color[color], theme2.size[size3]), children: [textLabel && labelText && textLabelPosition === "inside" && (0, import_jsx_runtime68.jsx)("span", { "data-testid": "flowbite-progress-inner-text-label", children: textLabel }), progress > 0 && labelProgress && progressLabelPosition === "inside" && (0, import_jsx_runtime68.jsxs)("span", { "data-testid": "flowbite-progress-inner-progress-label", children: [progress, "%"] })] }) })] }) });
};
...
var Radio = (0, import_react39.forwardRef)(({ className, theme: customTheme = {}, ...props }, ref) => {
  ...
  return (0, import_jsx_runtime69.jsx)("input", { ref, type: "radio", className: twMerge(theme2.root.base, className), ...props });
});
...
var RangeSlider = (0, import_react40.forwardRef)(({ className, sizing = "md", theme: customTheme = {}, ...props }, ref) => {
  ...
  return (0, import_jsx_runtime70.jsx)(import_jsx_runtime70.Fragment, { children: (0, import_jsx_runtime70.jsx)("div", { "data-testid": "flowbite-range-slider", className: twMerge(theme2.root.base, className), children: (0, import_jsx_runtime70.jsx)("div", { className: theme2.field.base, children: (0, import_jsx_runtime70.jsx)("input", { ref, type: "range", className: twMerge(theme2.field.input.base, theme2.field.input.sizes[sizing]), ...props }) }) }) });
});
...
var RatingAdvanced = ({ children, className, percentFilled = 0, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime71.jsxs)("div", { className: twMerge(theme2.base, className), ...props, children: [(0, import_jsx_runtime71.jsx)("span", { className: theme2.label, children }), (0, import_jsx_runtime71.jsx)("div", { className: theme2.progress.base, children: (0, import_jsx_runtime71.jsx)("div", { className: theme2.progress.fill, "data-testid": "flowbite-rating-fill", style: { width: `${percentFilled}%` } }) }), (0, import_jsx_runtime71.jsx)("span", { className: theme2.progress.label, children: `${percentFilled}%` })] });
};
...
var RatingStar = ({ className, filled = true, starIcon: Icon = HiStar, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime72.jsx)(Icon, { "data-testid": "flowbite-rating-star", className: twMerge(theme2.sizes[size3], theme2[filled ? "filled" : "empty"], className), ...props });
};
...
var RatingComponent = ({ children, className, size: size3 = "sm", theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime73.jsx)(RatingContext.Provider, { value: { theme: theme2, size: size3 }, children: (0, import_jsx_runtime73.jsx)("div", { className: twMerge(theme2.root.base, className), ...props, children }) });
};
...
var SidebarCTA = ({ children, color = "info", className, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime75.jsx)("div", { "data-testid": "sidebar-cta", hidden: isCollapsed, className: twMerge(theme2.base, theme2.color[color], className), ...props, children });
};
...
var Floating = ({ animation = "duration-300", arrow: arrow4 = true, children, className, content, placement = "top", style = "dark", theme: theme2, trigger = "hover", minWidth, ...props }) => {
  ...
  return (0, import_jsx_runtime76.jsxs)(import_jsx_runtime76.Fragment, { children: [(0, import_jsx_runtime76.jsx)("div", { ref: refs.setReference, className: theme2.target, "data-testid": "flowbite-tooltip-target", ...getReferenceProps(), children }), (0, import_jsx_runtime76.jsxs)("div", { ref: refs.setFloating, "data-testid": "flowbite-tooltip", ...getFloatingProps({
...
var Tooltip = ({ animation = "duration-300", arrow: arrow4 = true, children, className, content, placement = "top", style = "dark", theme: customTheme = {}, trigger = "hover", ...props }) => {
  ...
  return (0, import_jsx_runtime77.jsx)(Floating, { animation, arrow: arrow4, content, placement, style, theme: theme2, trigger, className, ...props, children });
};
...
var SidebarCollapse = ({ children, className, icon: Icon, label, chevronIcon: ChevronIcon = HiChevronDown, renderChevronIcon, open = false, theme: customTheme = {}, ...props }) => {
  ...
  const Wrapper = ({ children: children2 }) => (0, import_jsx_runtime78.jsx)("li", { children: isCollapsed && !isOpen ? (0, import_jsx_runtime78.jsx)(Tooltip, { content: label, placement: "right", children: children2 }) : children2 });
  return (0, import_jsx_runtime78.jsxs)(Wrapper, { children: [(0, import_jsx_runtime78.jsxs)("button", { id: `flowbite-sidebar-collapse-${id}`, onClick: () => setOpen(!isOpen), title: label, type: "button", className: twMerge(theme2.button, className), ...props, children: [Icon && (0, import_jsx_runtime78.jsx)(Icon, { "aria-hidden": true, "data-testid": "flowbite-sidebar-collapse-icon", className: twMerge(theme2.icon.base, theme2.icon.open[isOpen ? "on" : "off"]) }), isCollapsed ? (0, import_jsx_runtime78.jsx)("span", { className: "sr-only", children: label }) : (0, import_jsx_runtime78.jsxs)(import_jsx_runtime78.Fragment, { children: [(0, import_jsx_runtime78.jsx)("span", { "data-testid": "flowbite-sidebar-collapse-label", className: theme2.label.base, children: label }), renderChevronIcon ? renderChevronIcon(theme2, isOpen) : (0, import_jsx_runtime78.jsx)(ChevronIcon, { "aria-hidden": true, className: twMerge(theme2.label.icon.base, theme2.label.icon.open[isOpen ? "on" : "off"]) })] })] }), (0, import_jsx_runtime78.jsx)("ul", { "aria-labelledby": `flowbite-sidebar-collapse-${id}`, hidden: !isOpen, className: theme2.list, children: (0, import_jsx_runtime78.jsx)(SidebarItemContext.Provider, { value: { isInsideCollapse: true }, children }) })] });
};
...
"use client";
var ListItem2 = ({ id, theme: theme2, isCollapsed, tooltipChildren, children: wrapperChildren, ...props }) => (0, import_jsx_runtime79.jsx)("li", { ...props, children: isCollapsed ? (0, import_jsx_runtime79.jsx)(Tooltip, { content: (0, import_jsx_runtime79.jsx)(Children4, { id, theme: theme2, children: tooltipChildren }), placement: "right", children: wrapperChildren }) : wrapperChildren });
var Children4 = ({ id, theme: theme2, children }) => {
  return (0, import_jsx_runtime79.jsx)("span", { "data-testid": "flowbite-sidebar-item-content", id: `flowbite-sidebar-item-${id}`, className: twMerge(theme2.content.base), children });
};
var SidebarItem = (0, import_react48.forwardRef)(({ active: isActive, as: Component = "a", children, className, icon: Icon, label, labelColor = "info", theme: customTheme = {}, ...props }, ref) => {
  ...
  return (0, import_jsx_runtime79.jsx)(ListItem2, { theme: theme2, className: theme2.listItem, id, isCollapsed, tooltipChildren: children, children: (0, import_jsx_runtime79.jsxs)(Component, { "aria-labelledby": `flowbite-sidebar-item-${id}`, ref, className: twMerge(theme2.base, isActive && theme2.active, !isCollapsed && isInsideCollapse && theme2.collapsed?.insideCollapse, className), ...props, children: [Icon && (0, import_jsx_runtime79.jsx)(Icon, { "aria-hidden": true, "data-testid": "flowbite-sidebar-item-icon", className: twMerge(theme2.icon?.base, isActive && theme2.icon?.active) }), isCollapsed && !Icon && (0, import_jsx_runtime79.jsx)("span", { className: theme2.collapsed?.noIcon, children: children.charAt(0).toLocaleUpperCase() ?? "?" }), !isCollapsed && (0, import_jsx_runtime79.jsx)(Children4, { id, theme: theme2, children }), !isCollapsed && label && (0, import_jsx_runtime79.jsx)(Badge, { color: labelColor, "data-testid": "flowbite-sidebar-label", hidden: isCollapsed, className: theme2.label, children: label })] }) });
});
...
var SidebarItemGroup = ({ children, className, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime80.jsx)("ul", { "data-testid": "flowbite-sidebar-item-group", className: twMerge(theme2.base, className), ...props, children: (0, import_jsx_runtime80.jsx)(SidebarItemContext.Provider, { value: { isInsideCollapse: false }, children }) });
};
...
var SidebarItems = ({ children, className, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime81.jsx)("div", { className: twMerge(theme2.base, className), "data-testid": "flowbite-sidebar-items", ...props, children });
};
...
var SidebarLogo = ({ children, className, href, img, imgAlt = "", theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime82.jsxs)("a", { "aria-labelledby": `flowbite-sidebar-logo-${id}`, href, className: twMerge(theme2.base, className), ...props, children: [(0, import_jsx_runtime82.jsx)("img", { alt: imgAlt, src: img, className: theme2.img }), (0, import_jsx_runtime82.jsx)("span", { className: theme2.collapsed[isCollapsed ? "on" : "off"], id: `flowbite-sidebar-logo-${id}`, children })] });
};
...
var SidebarComponent = ({ children, as: Component = "nav", collapseBehavior = "collapse", collapsed: isCollapsed = false, theme: customTheme = {}, className, ...props }) => {
  ...
  return (0, import_jsx_runtime83.jsx)(SidebarContext.Provider, { value: { theme: theme2, isCollapsed }, children: (0, import_jsx_runtime83.jsx)(Component, { "aria-label": "Sidebar", hidden: isCollapsed && collapseBehavior === "hide", className: twMerge(theme2.root.base, theme2.root.collapsed[isCollapsed ? "on" : "off"], className), ...props, children: (0, import_jsx_runtime83.jsx)("div", { className: theme2.root.inner, children }) }) });
};
...
tabbable/dist/index.esm.js:
  ...
  *)
*/
//# sourceMappingURL=/build/_shared/chunk-Z2BYYI2L.js.map
